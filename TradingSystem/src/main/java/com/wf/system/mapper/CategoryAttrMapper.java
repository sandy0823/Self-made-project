...
public interface CategoryAttrMapper {
	 ...
	 * @mbg.generated
	 */
	@Delete({ "delete from category_attr", "where id = #{id,jdbcType=INTEGER}" })
	 ...
	 * @mbg.generated
	 */
	@Insert({ "insert into category_attr (id, name, ", "descript, parent_second_category_id)",
	 ...
	 * @mbg.generated
	 */
	@Select({ "select", "id, name, descript, parent_second_category_id", "from category_attr",
	 ...
	 * @mbg.generated
	 */
	@Update({ "update category_attr", "set name = #{name,jdbcType=VARCHAR},",
